package com.example.kafka.streams.poc.common.kafka.model;
...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.sylleryum.common.kafka.model.PaymentStatus paymentStatus;
   ...
   */
  public PaymentResponseAvroModel(String id, String sagaId, String paymentId, String customerId, String orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.sylleryum.common.kafka.model.PaymentStatus paymentStatus, java.util.List<String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
      ...
      case 7: paymentStatus = (com.sylleryum.common.kafka.model.PaymentStatus)value$; break;
   ...
   */
  public com.sylleryum.common.kafka.model.PaymentStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(com.sylleryum.common.kafka.model.PaymentStatus value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @return This builder.
     */
    public Builder setPaymentStatus(com.sylleryum.common.kafka.model.PaymentStatus value) {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus : (com.sylleryum.common.kafka.model.PaymentStatus) defaultValue(fields()[7]);
