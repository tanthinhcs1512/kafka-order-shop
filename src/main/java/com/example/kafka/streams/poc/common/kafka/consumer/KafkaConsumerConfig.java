package com.example.kafka.streams.poc.common.kafka.consumer;

import com.example.kafka.streams.poc.common.kafka.config.KafkaConfigData;
import com.example.kafka.streams.poc.common.kafka.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(kafkaConfigData.getSchemaRegistryUrlKey(), kafkaConfigData);
