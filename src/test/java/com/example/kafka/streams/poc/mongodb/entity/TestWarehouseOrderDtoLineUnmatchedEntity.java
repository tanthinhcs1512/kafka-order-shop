...
/**
 * Unit test for warehouse order line unmatched mongoDB entity
 */
@SpringBootTest
@RunWith(MockitoJUnitRunner.class)
public class TestWarehouseOrderDtoLineUnmatchedEntity {
    @Test
    public void testEmptyConstructor() {

        WarehouseOrderLineEntity source = new WarehouseOrderLineEntity();
        WarehouseOrderLineUnmatchedEntity target = new WarehouseOrderLineUnmatchedEntity();
    ...
    public void testCopyConstructor() {
        ...
        WarehouseOrderLineUnmatchedEntity target = new WarehouseOrderLineUnmatchedEntity(line);
