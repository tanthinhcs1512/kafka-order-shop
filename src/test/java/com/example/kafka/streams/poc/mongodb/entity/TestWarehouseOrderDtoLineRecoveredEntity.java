...
/**
 * Unit test for warehouse order line recovered mongoDB entity
 */
@SpringBootTest
@RunWith(MockitoJUnitRunner.class)
public class TestWarehouseOrderDtoLineRecoveredEntity {
    @Test
    public void testEmptyConstructor() {

        WarehouseOrderLineEntity source = new WarehouseOrderLineEntity();
        WarehouseOrderLineRecoveredEntity target = new WarehouseOrderLineRecoveredEntity();
    ...
    public void testCopyConstructor() {
        ...
        WarehouseOrderLineRecoveredEntity target = new WarehouseOrderLineRecoveredEntity(line);
