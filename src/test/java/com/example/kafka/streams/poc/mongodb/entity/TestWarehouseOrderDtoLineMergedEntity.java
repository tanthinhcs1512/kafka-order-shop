...
/**
 * Unit test for warehouse order line merged mongoDB entity
 */
@SpringBootTest
@RunWith(MockitoJUnitRunner.class)
public class TestWarehouseOrderDtoLineMergedEntity {
    @Test
    public void testEmptyConstructor() {

        WarehouseOrderLineEntity source = new WarehouseOrderLineEntity();
        WarehouseOrderLineMergedEntity target = new WarehouseOrderLineMergedEntity();
    ...
    public void testCopyConstructor() {
        ...
        WarehouseOrderLineMergedEntity target = new WarehouseOrderLineMergedEntity(line);
