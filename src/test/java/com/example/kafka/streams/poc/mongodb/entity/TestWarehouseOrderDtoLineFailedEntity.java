...
/**
 * Unit test for warehouse order line failed mongoDB entity
 */
@SpringBootTest
@RunWith(MockitoJUnitRunner.class)
public class TestWarehouseOrderDtoLineFailedEntity {
    @Test
    public void testEmptyConstructor() {

        WarehouseOrderLineEntity source = new WarehouseOrderLineEntity();
        WarehouseOrderLineFailedEntity target = new WarehouseOrderLineFailedEntity();
    ...
    public void testCopyConstructor() {
        ...
        WarehouseOrderLineFailedEntity target = new WarehouseOrderLineFailedEntity(line);
