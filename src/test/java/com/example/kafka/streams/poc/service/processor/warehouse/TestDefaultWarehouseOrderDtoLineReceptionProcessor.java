...
/**
 * Unit test for DefaultWarehouseOrderLineReceptionProcessor service
 */
@SpringBootTest
@DirtiesContext
@RunWith(MockitoJUnitRunner.class)
public class TestDefaultWarehouseOrderDtoLineReceptionProcessor {
    ...
    public void testProcessCallsInsertWhenNew() {
        ...
        DefaultWarehouseOrderLineReceptionProcessor processor = new DefaultWarehouseOrderLineReceptionProcessor(repository);
